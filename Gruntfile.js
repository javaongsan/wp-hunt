module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        browserify: {
            ...
            dist: { files: { 'assets/js/wp-hunt.js': 'assets/js/components/main.js' } }
        },
        uglify: {
            dist: {
                files: { 'assets/js/wp-hunt.min.js': 'assets/js/wp-hunt.js' },
        ...
        sass: {
            dist: {
                ...
                files: {
                    'assets/css/wp-hunt.css': 'assets/css/sass/styles.scss', 
                    'assets/css/wp-hunt-public.css': 'assets/css/sass/public-styles.scss'
                }
            }
        },
        cssmin: {
            dist: {
                files: { 
                    'assets/css/wp-hunt.min.css': 'assets/css/wp-hunt.css',
                    'assets/css/wp-hunt-public.min.css': 'assets/css/wp-hunt-public.css'
                } 
            } 
        },
        usebanner: {
            taskName: {
                ...
                files: {
                    src: [
                    'assets/css/wp-hunt.min.css',
                    'assets/css/wp-hunt-public.min.css'
                    ]
                }
            }
        }
